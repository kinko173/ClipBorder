...
import os
#sys.path.append(os.path.abspath("C:/Users/cctep/MWS2025/my_tool/python_env/DLLs"))
...
_base_dir = os.path.abspath(os.path.join(_this_dir, "..", "..", ".."))  # 例: python_env/
_dll_path = os.path.join(_base_dir, "DLLs", "_tkinter.pyd")

if os.path.exists(_dll_path):
    loader = importlib.machinery.ExtensionFileLoader("_tkinter", _dll_path)
    spec = importlib.util.spec_from_loader("_tkinter", loader)
    _tkinter = importlib.util.module_from_spec(spec)
    loader.exec_module(_tkinter)
    sys.modules["_tkinter"] = _tkinter
else:
    # 見つからなければ通常の import を試す
